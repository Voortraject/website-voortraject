...
export const NIVEAU_KAART: Record<SubsidieNiveau, string> = {
  rijk: "border-[hsl(var(--niveau-rijk)/0.22)] border-l-[hsl(var(--niveau-rijk))] bg-[hsl(var(--niveau-rijk)/0.03)]",
  provincie:
    "border-[hsl(var(--niveau-provincie)/0.25)] border-l-[hsl(var(--niveau-provincie))] bg-[hsl(var(--niveau-provincie)/0.03)]",
  gemeente:
    "border-[hsl(var(--niveau-gemeente)/0.3)] border-l-[hsl(var(--niveau-gemeente))] bg-[hsl(var(--niveau-gemeente)/0.04)]",
  overig:
    "border-[hsl(var(--niveau-overig)/0.25)] border-l-[hsl(var(--niveau-overig))] bg-[hsl(var(--niveau-overig)/0.03)]",
};
