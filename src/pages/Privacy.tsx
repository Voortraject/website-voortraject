...
const sections = [
  {
    ...
    content: `Voortraject VOF (hierna: "Voortraject", "wij" of "ons"), gevestigd aan de Viaductstraat 3-15, 9725 BG te Groningen en ingeschreven bij de Kamer van Koophandel onder nummer 42066892, is verwerkingsverantwoordelijke in de zin van artikel 4, onderdeel 7, van de Algemene verordening gegevensbescherming (AVG).

Voortraject begeleidt woningeigenaren (bewoners) en ondersteunt uitvoerende verduurzamingsbedrijven (uitvoerders) in het voortraject van isolatie- en verduurzamingsprojecten, voornamelijk in Groningen en Noord-Drenthe en mede in het kader van de subsidieregelingen onder Nij Begun. Onze dienstverlening omvat onder meer advisering, woningopname (schouw), het opstellen van offertes, het koppelen van bewoners aan uitvoerders en het samen met bewoners indienen van subsidieaanvragen.

In deze privacyverklaring leggen wij uit welke persoonsgegevens wij verwerken, met welk doel, op welke grondslag en welke rechten u daarbij heeft.

Heeft u vragen of wilt u een verzoek indienen? Neem contact met ons op via info@voortraject.nl.`,
  },
  {
    title: "2. Op wie is deze verklaring van toepassing?",
    content: `Deze privacyverklaring geldt voor de verwerking van persoonsgegevens van:

• bewoners en (potentiële) opdrachtgevers;
• contactpersonen van uitvoerders en samenwerkingspartners;
• bezoekers van onze website;
• overige personen met wie wij contact hebben in het kader van onze dienstverlening.`,
  },
  {
    title: "3. Welke persoonsgegevens verwerken wij?",
    content: `Afhankelijk van uw relatie tot Voortraject verwerken wij onder meer:

• Identificatie- en contactgegevens: naam, adres, postcode, woonplaats, telefoonnummer en e-mailadres;
• Gegevens over de woning: adres, bouwjaar, energielabel en andere energiegegevens, gewenste en uitgevoerde isolatie- en verduurzamingsmaatregelen, en foto's die tijdens de woningopname (schouw) worden gemaakt;
• Subsidie- en dossiergegevens: gegevens over uw aanvraag, het advies, de offerte en de voortgang van uw traject;
...
• Technische gegevens: IP-adres, apparaatgegevens en gegevens over uw gebruik van onze website.`,
  ...
  {
    title: "4. Waar komen uw gegevens vandaan?",
    content: `Wij verkrijgen persoonsgegevens:
...
Wanneer wij gegevens van uitvoerders of hun contactpersonen uit openbare bronnen verkrijgen, informeren wij de betrokkene daarover overeenkomstig artikel 14 AVG.`,
  ...
  {
    title: "5. Verwerking van het burgerservicenummer (BSN)",
    content: `Voor bepaalde inkomensafhankelijke subsidies moet bij de aanvraag een inkomensverklaring van de Belastingdienst worden meegestuurd. Op deze inkomensverklaring staat het burgerservicenummer (BSN) van de aanvrager vermeld. In die gevallen verwerken wij dus tijdelijk een BSN.

Wij verwerken het BSN uitsluitend om de subsidieaanvraag, op basis van de door u verstrekte machtiging, samen met u of namens u bij het Samenwerkingsverband Noord-Nederland (SNN) in te dienen. Wij gebruiken het BSN voor geen enkel ander doel.
...
• Het samen met u indienen van subsidieaanvragen bij het SNN. Grondslag: uitvoering van de overeenkomst. U verstrekt ons hiervoor een machtiging. Die machtiging geeft ons de bevoegdheid om de aanvraag samen met u of namens u in te dienen; zij betreft uw vertegenwoordiging en is geen afzonderlijke grondslag voor gegevensverwerking.
• Het koppelen van bewoners aan een geschikte uitvoerder en het delen van de daarvoor benodigde gegevens. Grondslag: uitvoering van de overeenkomst.
...
Verwerken wij gegevens op basis van uw toestemming, dan kunt u die toestemming op elk moment intrekken. Dit laat de rechtmatigheid van de verwerking vóór de intrekking onverlet.
...
const Privacy = () => {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Seo
        title="Privacyverklaring | Voortraject"
        description="Lees hier de privacyverklaring van Voortraject. Wij leggen uit welke persoonsgegevens wij verwerken, met welk doel en welke rechten u heeft."
        path="/privacy"
      />
      <Header />
